...
void main() {
  ...
  test('JSONData should load json file data correctly', () {
    final sut = JSONData();
    sut.load('./files/example_files/json_example.json');
  ...
  test('JSONData should save json in filePath with correct Data', () {
    ...
    sut.save('./files/.generated/json_equivalent.json');
    sut.clear();
    sut.load('./files/.generated/json_equivalent.json');
  ...
  test('JSONData should throw file not found error', () {
    final sut = JSONData();
    expect(() => sut.load('./files/example_files/json_example_not_found.json'), throwsA(isA<FileNotFoundError>()));
  });
  ...
  test('JSONData should throw no data error', () {
    final sut = JSONData();
    expect(() => sut.save('./files/.generated/json_equivalent.json'), throwsA(isA<NoDataError>()));
  });
}